...
const testimonials: TestimonialData[] = [
  {
    quote: "Die Qualität der Arbeit hat unsere Erwartungen übertroffen. Jedes Detail stimmt.",
  ...
  {
    quote: "Professionell, zuverlässig und handwerklich perfekt. Absolut empfehlenswert!",
  ...
  {
    quote: "Von der Beratung bis zur Montage ein rundum gelungenes Projekt.",
    author: "Anna Weber",
    role: "Möbeldesign",
    company: "Plochingen",
  ...
  {
    quote: "Unsere neue Haustür ist ein echtes Schmuckstück. Vielen Dank!",
